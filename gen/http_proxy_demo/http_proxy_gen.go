...
func main() {
	...
	GenByStruct(inputFile, outputFile, "@httpProxy", temp, []string{"Call"})
}

func GenByStruct(inputFile, outputFile, keyword, temp string, scanMethods []string) {
